 ...
 */
public class IfInterceptor extends SQLElementInterceptor {
    ...
    public IfInterceptor(SQLExecutableElement next, SQLBasedElement sql) {
        super(next);
        expression = Expression.compile(sql.getIf());
        location = sql.getLocation();
    }
