...
# Phase 10: JDK 17 Compatibility — Deferred to 1.4

JDK 17 compatibility was deliberately excluded from Scriptella 1.3. The
release retains its validated Java 8 baseline and makes no JDK 17 support
claim.

Investigation findings, implementation work, packaging decisions, and the
cross-JDK validation matrix now belong to the
[Scriptella 1.4 plan](../1.4/release-1.4-plan.md) under GitHub issues
[#31](https://github.com/scriptella/scriptella-etl/issues/31) and
[#44](https://github.com/scriptella/scriptella-etl/issues/44).
...
* implementing JDK 17 compatibility or related scripting modernization
...
JDK compatibility, Rhino packaging, dependency staging, and related
modernization now belong to the
[Scriptella 1.4 plan](../1.4/release-1.4-plan.md).
