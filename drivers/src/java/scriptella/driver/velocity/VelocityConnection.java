...
public class VelocityConnection extends AbstractTextConnection {
    ...
    public VelocityConnection(ConnectionParameters parameters) {
        ...
        // Preserve the whitespace behavior of the former Velocity 1.x driver.
    ...
    private static class VelocityContextAdapter implements Context {
        ...
        public Object put(String key, Object value) {
            if (localParameters == null) {
                localParameters = new HashMap<String, Object>();
            }
        ...
        public String[] getKeys() {
            return localParameters == null ? new String[0] :
                    localParameters.keySet().toArray(new String[0]);
        }
