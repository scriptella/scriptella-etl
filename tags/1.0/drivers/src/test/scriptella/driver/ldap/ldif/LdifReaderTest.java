    ...
    public void testLdifParserRFC2849Sample4() throws NamingException, Exception {
        String ldif =
                "version: 1\n" +
                        ...
                        "# dn:: ou=õÖ?öåíùÃè,o=Airius\n" +
                        "objectclass: top\n" +
                        "objectclass: organizationalUnit\n" +
                        "ou:: 5Za25qWt6YOo\n" +
                        "# ou:: õÖ?öåíùÃè\n" +
                        "ou;lang-ja:: 5Za25qWt6YOo\n" +
                        "# ou;lang-ja:: õÖ?öåíùÃè\n" +
                        "ou;lang-ja;phonetic:: 44GI44GE44GO44KH44GG44G2\n" +
                        "# ou;lang-ja:: óÁÈóÁÄóÁÎóÂÇóÁÆóÁ?\n" +
                        "ou;lang-en: Sales\n" +
                        "description: Japanese office\n" +
                        "\n" +
                        "dn:: dWlkPXJvZ2FzYXdhcmEsb3U95Za25qWt6YOoLG89QWlyaXVz\n" +
                        "# dn:: uid=rogasawara,ou=õÖ?öåíùÃè,o=Airius\n" +
                        ...
                        "# givenname;lang-ja:: óÃíóÃÉóÃËóÃ?\n" +
                        "sn;lang-ja:: 5bCP56yg5Y6f\n" +
                        "# sn;lang-ja:: õ?Ï÷ìàõÎß\n" +
                        "cn;lang-ja:: 5bCP56yg5Y6fIOODreODieODi+ODvA==\n" +
                        "# cn;lang-ja:: õ?Ï÷ìàõÎß óÃíóÃÉóÃËóÃ?\n" +
                        "title;lang-ja:: 5Za25qWt6YOoIOmDqOmVtw==\n" +
                        "# title;lang-ja:: õÖ?öåíùÃè ùÃèùÕ?\n" +
                        "preferredlanguage: ja\n" +
                        "givenname:: 44Ot44OJ44OL44O8\n" +
                        "# givenname:: óÃíóÃÉóÃËóÃ?\n" +
                        "sn:: 5bCP56yg5Y6f\n" +
                        "# sn:: õ?Ï÷ìàõÎß\n" +
                        "cn:: 5bCP56yg5Y6fIOODreODieODi+ODvA==\n" +
                        "# cn:: õ?Ï÷ìàõÎß óÃíóÃÉóÃËóÃ?\n" +
                        "title:: 5Za25qWt6YOoIOmDqOmVtw==\n" +
                        "# title:: õÖ?öåíùÃè ùÃèùÕ?\n" +
                        "givenname;lang-ja;phonetic:: 44KN44Gp44Gr44O8\n" +
                        "# givenname;lang-ja;phonetic:: óÂÍóÁéóÁëóÃ?\n" +
                        "sn;lang-ja;phonetic:: 44GK44GM44GV44KP44KJ\n" +
                        "# sn;lang-ja;phonetic:: óÁÊóÁÌóÁÕóÂÏóÂÉ\n" +
                        "cn;lang-ja;phonetic:: 44GK44GM44GV44KP44KJIOOCjeOBqeOBq+ODvA==\n" +
                        "# cn;lang-ja;phonetic:: óÁÊóÁÌóÁÎóÂÏóÂÉ óÂÍóÁéóÁëóÃ?\n" +
                        "title;lang-ja;phonetic:: 44GI44GE44GO44KH44GG44G2IOOBtuOBoeOCh+OBhg==\n" +
                        "# title;lang-ja;phonetic::\n" +
                        "# óÁÈóÁÄóÁÎóÂÇóÁÆóÁ? óÁ?óÁáóÂÇóÁÆ\n" +
        ...
        String[][][] values =
                {
                        {
                                {"dn", "ou=\u55b6\u696d\u90e8,o=Airius"}, // 55b6 = õÖ?, 696d = öåí, 90e8 = ùÃè
                                {"objectclass", "top"},
                                {"objectclass", "organizationalUnit"},
                                {"ou", "\u55b6\u696d\u90e8"},
                                {"ou;lang-ja", "\u55b6\u696d\u90e8"},
                                {"ou;lang-ja;phonetic", "\u3048\u3044\u304e\u3087\u3046\u3076"}, // 3048 = óÁÈ, 3044 = óÁÄ, 304e = óÁÎ
                                ...
                                {"description", "Japanese office"}},
                        {
                                ...
                                {"uid", "rogasawara"},
                                {"mail", "rogasawara@airius.co.jp"},
                                {"givenname;lang-ja", "\u30ed\u30c9\u30cb\u30fc"},    // 30ed = óÃí, 30c9 = óÃÉ, 30cb = óÃË, 30fc = óÃ?
                                {"sn;lang-ja", "\u5c0f\u7b20\u539f"},    // 5c0f = õ?Ï, 7b20 = ÷ìà, 539f = õÎß
                                {"cn;lang-ja", "\u5c0f\u7b20\u539f \u30ed\u30c9\u30cb\u30fc"},
                                {"title;lang-ja", "\u55b6\u696d\u90e8 \u90e8\u9577"},   // 9577 = ùÕ?
                                {"preferredlanguage", "ja"},
                                {"givenname", "\u30ed\u30c9\u30cb\u30fc"},
                                {"sn", "\u5c0f\u7b20\u539f"},
                                {"cn", "\u5c0f\u7b20\u539f \u30ed\u30c9\u30cb\u30fc"},
                                {"title", "\u55b6\u696d\u90e8 \u90e8\u9577"},
                                {"givenname;lang-ja;phonetic", "\u308d\u3069\u306b\u30fc"},  // 308d = óÂÍ,3069 = óÁé, 306b = óÁë
                                {"sn;lang-ja;phonetic", "\u304a\u304c\u3055\u308f\u3089"}, // 304a = óÁÊ, 304c = óÁÌ,3055 = óÁÕ,308f = óÂÏ, 3089 = óÂÉ
                                {"cn;lang-ja;phonetic", "\u304a\u304c\u3055\u308f\u3089 \u308d\u3069\u306b\u30fc"},
                                {"title;lang-ja;phonetic", "\u3048\u3044\u304e\u3087\u3046\u3076 \u3076\u3061\u3087\u3046"}, // 304E = óÁÎ, 3061 = óÁá
                                {"givenname;lang-en", "Rodney"},
                                {"sn;lang-en", "Ogasawara"},
                                {"cn;lang-en", "Rodney Ogasawara"},
                                {"title;lang-en", "Sales, Director"}
